...
const NewsletterSubscribe = (props: Props) => {
  ...
  return (
    <form action={create}>
      <div>
        <input type="email" name="email" id="email" placeholder='Enter your email' className='mt-6 border-2 rounded-full rounded-r-none py-3 px-4 bg-gray-200 text-gray-800 outline-none placeholder-gray-500 focus:bg-gray-100 flex-1 p-2' />
